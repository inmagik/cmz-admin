// Make an error message for humans
// TODO: Better human message
const errorMessageForHumans = ({ status, statusText, headers, body, json }) =>
    ...
    .then(text => {
      ...
      if (status < 200 || status >= 300) {
        return Promise.reject({
          // Handly message fof UI display
          message: errorMessageForHumans({ status, statusText, headers, body, json }),
